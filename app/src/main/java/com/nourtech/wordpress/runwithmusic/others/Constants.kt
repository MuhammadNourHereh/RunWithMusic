...
object Constants {
    ...
    const val ACTION_START_PAUSE_MUSIC = "ACTION_START_MUSIC"
    const val ACTION_PAUSE_MUSIC = "ACTION_PAUSE_MUSIC"
    const val ACTION_RESUME_MUSIC = "ACTION_RESUME_MUSIC"
    const val ACTION_SKIP_PREVIOUS_SONG = "ACTION_PREVIOUS_SONG"
    const val ACTION_SKIP_NEXT_SONG = "ACTION_NEXT_SONG"
    const val ACTION_SEEK_MUSIC = "ACTION_SEEK_MUSIC"
